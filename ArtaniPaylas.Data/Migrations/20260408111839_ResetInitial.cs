        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "character varying(260)", maxLength: 260, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_AspNetUsers_RequesterUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_RequestId_FromUserId",
                table: "Reviews",
                columns: new[] { "RequestId", "FromUserId" },
                unique: true);
